 ...
 */
Ext.define('AlfaClick.view.app.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: ['AlfaClick.view.app.PortalColumn'],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('AlfaClick.view.app.PortalDropZone', this, this.dropConfig);
    },
